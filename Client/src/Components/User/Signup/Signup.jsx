...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-sky-500 to-sky-900">
    <div className="bg-white opacity-90 mt-20 mb-20 rounded-lg p-4 md:p-6 shadow-md max-w-md mx-auto flex flex-col items-center justify-center space-y-4">
        ...
        <form className="w-full">
            <div className="mb-4 space-y-2">
                <input
                    name="name"
                    className="border rounded-lg px-3 py-2 w-full text-sm focus:ring focus:ring-teal-500 focus:outline-none placeholder-gray-400"
                    type="text"
                    value={username}
