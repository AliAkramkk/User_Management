...
import { clientLogin,adminLogin, adminLogout } from '../../../Redux/Client';
...
const Login = () => {
  ...
  const handleLogin = (e)=>{
    ...
    .then((res)=>{
      ...
      return (
      <div className="flex items-center  justify-center min-h-screen bg-gradient-to-r from-sky-500 to-sky-900">
